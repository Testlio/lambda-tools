...
const functionName = 'lambda-tools-api-gateway-resource';
const roleName = 'lambda-tools-helper';
...
module.exports = function(region) {
    ...
    process.stdout.write('\tCreating lambda execution role \'' + roleName + '\'');
    ensureLambdaRole(roleName, 'inline-policy').then(function(role) {
        console.log(' ✔'.green);

        // Create or update the Lambda function
        process.stdout.write('\tCreating lambda function \'' + functionName + '\'');
        return updateOrCreateFunction(functionName, zipFile, role).then(function(lambda) {
            console.log(' ✔'.green);
