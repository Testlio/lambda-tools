...
function getDirectoryTree(dir) {
    ...
    return new Promise(function(resolve) {
        fs.walk(dir).on('data', function (item) {
...
module.exports = function *(lambdaPath, event, context, environment, assets) {
    ...
    .then(function(originalDirectory) {
        return new Promise(function(resolve, reject) {
            ...
            return getDirectoryTree(directory).then(function(modifiedDirectory) {
                // List all paths that were previously not there, and erase them
                const diff = _.difference(modifiedDirectory, originalDirectory);
