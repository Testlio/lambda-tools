...
module.exports = function(context) {
    return new Promise(function(resolve) {
        ...
        const projectNameAcronym = _.kebabCase(projectName).split('-').map(function(s) { return s.charAt(0); }).join('');
        ...
        stackCF["Parameters"]["aaProjectNameAcronym"] = {
            "Type": "String",
            "Default": projectNameAcronym,
            "AllowedValues": [
                projectNameAcronym
            ]
        };
