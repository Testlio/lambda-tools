    ...
    return new Promise(function(resolve) {
        ...
        return context.logger.task('Processing Lambdas', function(finish, fail) {
            ...
            return Promise.mapSeries(context.lambdas, function(lambda) {
                ...
                const assets = lambda.assets;   // Statically included assets
                ...
                return context.logger.task(lambda.name, function(resolve, reject) {
                    ...
                    .then(function(bundledCode) {
                        ...
                        return fs.writeFileAsync(bundledPath, bundledCode).then(function() {
                            return bundledPath;
                        })
                    })
                    .then(function(bundledPath) {
                    ...
                    .then(function(manifest) {
                        ...
                        .then(function(result) {
                            ...
                            if (rebundle) {
                                return fs.writeFileAsync(manifestPath, JSON.stringify(manifest)).then(function() {
                                    return result;
                                });
                            } else {
                                return result;
                    ...
                    .then(function(result) {
                        ...
                        return logger.task('Transpiling', function(res, rej) {
                            ...
                            babel.transformFile(bundledPath, options, function(err, result) {
                        ...
                        .then(function(transpiledCode) {
                            ...
                            return fs.writeFileAsync(transpiledPath, transpiledCode).then(function() {
                                return transpiledPath;
                            });
                        })
                        .then(function(transpiledPath) {
