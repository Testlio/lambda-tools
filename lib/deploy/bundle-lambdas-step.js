...
module.exports = function(context) {
    ...
    let restoreEnvironment = _.assign({}, process.env);
    ...
    return new Promise(function(resolve) {
        ...
        return Promise.mapSeries(context.lambdas, function(lambda) {
            ...
            return bundleLambda(lambda, context.program.minify, context.program.environment, bundledPath).then(function(zippedData) {
...
function bundleLambda(lambda, minify, environment, bundledPath) {
