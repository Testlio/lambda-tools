...
function bundleLambda(options, cwd, context) {
    return context.logger.task(options.name, function(resolve, reject) {
        ...
        .then(function(lambdaCode) {
            ...
            return context.logger.task('Compressing', function(resolve, reject) {
...
module.exports = function(context) {
    ...
    return new Promise(function(resolve) {
        ...
        return context.logger.task('Processing Lambdas', function(resolve, reject) {
